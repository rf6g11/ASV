...
#
#05/02/2015 Edited the code to be used with a Beagle Bone Black as a control
#	    unit. It requires the user to install the Adafruit_BBIO library.
#
########################################################
#Notes
...
def setUpSerial():
    ...
    UART.setup("UART1") 
    serialPort = serial.Serial(port='/dev/ttyO1', baudrate='9600', timeout= 0.1) # may need to change timeout if having issues!
