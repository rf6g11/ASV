...
#mission_script.py
#
# 10/3/2014 bollard pull states were added to check the battery discharge and to calibrate the thrust block
#
...
from state_bollard                import Bollard
...
################################################################################
        ...
        smach.StateMachine.add('INITIALISE', Initialise(lib,15), #(lib, timeout)	This state ensure all systems are running correctly proir to starting the mission proper
            transitions={'succeeded':'WAYPOINT1', 'aborted':'STOP','preempted':'STOP'}) 
            
#        smach.StateMachine.add('BOLLARD1', Bollard(lib, 100, 18000),  #(lib, rpm ,timeout(s))
